...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Pedido ped1 = new Pedido(null, sdf.parse("30/09/2007 10:32"), cli1, e1);
		Pedido ped2 = new Pedido(null, sdf.parse("10/10/2007 11:35"), cli1, e2);
		...
		//cada pedido(lista) conhece seus itens(presos):
		ped1.getItens().addAll(Arrays.asList(ip1, ip2));
		ped2.getItens().addAll(Arrays.asList(ip3));
		
		//cada produto(preso) conhece seus itens(saida):
